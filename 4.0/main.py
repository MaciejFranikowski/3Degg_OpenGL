...
def draw_egg(vertex_array):
    ...
    for u in range(0, N-1):
        for v in range(0, N-1):
            ...
            glColor3f(vertex_array[u, v+1, 3], vertex_array[u, v+1, 4], vertex_array[u, v+1, 5])
            glVertex3f(vertex_array[u, v+1, 0], vertex_array[u, v+1, 1], vertex_array[u, v+1, 2])
            glColor3f(vertex_array[u + 1, v + 1, 3], vertex_array[u + 1, v + 1, 4], vertex_array[u + 1, v + 1, 5])
            glVertex3f(vertex_array[u + 1, v + 1, 0], vertex_array[u + 1, v + 1, 1], vertex_array[u + 1, v + 1, 2])
            glColor3f(vertex_array[u, v+1, 3], vertex_array[u, v+1, 4], vertex_array[u, v+1, 5])
            glVertex3f(vertex_array[u, v + 1, 0], vertex_array[u, v + 1, 1], vertex_array[u, v + 1, 2])
            glColor3f(vertex_array[u+1, v, 3], vertex_array[u+1, v, 4], vertex_array[u+1, v, 5])
            glVertex3f(vertex_array[u + 1, v, 0], vertex_array[u + 1, v, 1], vertex_array[u + 1, v, 2])
